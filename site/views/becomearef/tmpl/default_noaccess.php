...
/**
 * Site's Become a Refeee View - No Access Template.
 * default_noaccess.php 
 **/
...
$message = $this->params->get('becomeareferrormessage');
...
{
	$html[] = JText::_('COM_BOOTCAMPLEADERBOARDS_BECOMEAREF_NOACCESS');	
}

...
class BootcampleaderboardsViewCreateateam extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		if($menu)
		{
			...
			$this->params->def('page_heading', JText::_('COM_BOOTCAMPLEADERBOARDS_CREATEATEAM_DEFAULT_PAGE_TITLE'));
		}

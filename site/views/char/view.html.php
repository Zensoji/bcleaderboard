...
class BootcampleaderboardsViewChar extends JView
{
	// Overwriting JView display method
	function display($tpl = null) 
	{
		$char_id = JRequest::getVar( 'char_id', '', 'default', 'int' );
		$templateName = JRequest::getVar( 'chartemplate', '', 'default', 'string' );
		
		$model = $this->getModel();
		$state = $this->get('State');	
		$item = $model->getData($char_id);

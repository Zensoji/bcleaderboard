...
class BootcampleaderboardsViewJointeam extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		if($menu)
		{
			...
			$this->params->def('page_heading', JText::_('COM_BOOTCAMPLEADERBOARDS_JOINTEAM_DEFAULT_PAGE_TITLE'));
		}

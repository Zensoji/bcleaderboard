...
class BootcampleaderboardsViewLeaderboard extends JView
{
	// Overwriting JView display method
	function display($tpl = null) 
	{
		$leaderboard_id = JRequest::getVar( 'leaderboard_id', '', 'default', 'int' );
		$templateName = JRequest::getVar( 'leaderboardtemplate', '', 'default', 'string' );
		
		$model = $this->getModel();
		$state = $this->get('State');	
		$item = $model->getData($leaderboard_id);

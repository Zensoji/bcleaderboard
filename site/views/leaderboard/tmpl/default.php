...
/**
 * Site's Leaderboard View Default Template
 * default.php
 */
...
if ($templateName == '')
{
	$templateName = $this->params->get( 'leaderboardtemplate' , 'Default');	
}

require_once(JPATH_SITE.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_bootcampleaderboards'.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.'leaderboard'.DIRECTORY_SEPARATOR.$templateName.DIRECTORY_SEPARATOR.'template.php');

$templateClass = strtolower($templateName).'leaderboardtemplate';
